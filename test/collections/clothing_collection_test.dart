...
void main() {
  testWidgets('Clothing collection page has a title', (WidgetTester tester) async {
    ...
    // Verify that our clothing collection page has a title in the app bar.
    expect(find.descendant(of: find.byType(AppBar), matching: find.text('Clothing')), findsOneWidget);
  });
}
