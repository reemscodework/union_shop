...
void main() {
  testWidgets('Winter collection page has a title', (WidgetTester tester) async {
    ...
    // Verify that our winter collection page has a title in the app bar.
    expect(find.descendant(of: find.byType(AppBar), matching: find.text('Winter Favourites')), findsOneWidget);
  });
}
